...
function runStartDelay() {
    ...
    document.querySelector('.popup_img').addEventListener('click', () => {
        ...
        if (click_count == 3) {
            ...
            if (click_count==0) {
                document.querySelector('.popup_img').setAttribute('style', 'width:150px')
            } else if(click_count==1) {
                document.querySelector('.popup_img').setAttribute('style', 'width:220px')
            } else if(click_count==2) {
                document.querySelector('.popup_img').setAttribute('style', 'width:300px')
            }
        }
        click_count++
    })
